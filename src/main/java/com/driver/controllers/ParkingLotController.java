...
public class ParkingLotController {
    ...
    public ResponseEntity<Spot> addSpot(@PathVariable int parkingLotId, @RequestParam Integer numberOfWheels, @RequestParam Integer pricePerHour) throws ParkingLotNotPresent {
